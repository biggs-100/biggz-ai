...
Review lifecycle implements last-event closure: every terminal capture burns the exact active lineage under version lock and maintenance lease, retires compact receipts, and guarantees burned lineages are never reused.
