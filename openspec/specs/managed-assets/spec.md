...
Managed assets defines lifecycle for SDD global/local assets via `managed-assets.json` v1 — hashed install, skip/force, retirement, and drift hashing for doctor.
