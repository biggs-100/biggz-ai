# Candidate View Specification

## Purpose

Candidate view provides a read-only materialized view of a review candidate with SHA256-manifest integrity, NUL-delimited git parsing, and symlink/traversal guards. Ported from gentle-ai `lib/review-candidate-view.ts`.
