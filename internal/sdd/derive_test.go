...
func TestDeriveChangeStatusMatrix(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantDeps:  Dependencies{Proposal: DependencyBlocked, Specs: DependencyBlocked, Design: DependencyBlocked, Tasks: DependencyBlocked, Apply: DependencyBlocked, Verify: DependencyBlocked, Archive: DependencyBlocked},
		},
		{
			...
			wantNext:  "spec",
			wantApply: ApplyBlocked,
			wantDeps:  Dependencies{Proposal: DependencyAllDone, Specs: DependencyBlocked, Design: DependencyBlocked, Tasks: DependencyBlocked, Apply: DependencyBlocked, Verify: DependencyBlocked, Archive: DependencyBlocked},
		},
		{
			...
			wantNext:  "design",
			wantApply: ApplyBlocked,
			wantDeps:  Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyBlocked, Tasks: DependencyBlocked, Apply: DependencyBlocked, Verify: DependencyBlocked, Archive: DependencyBlocked},
		},
		{
			...
			wantNext:  "tasks",
			wantApply: ApplyBlocked,
			wantDeps:  Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyAllDone, Tasks: DependencyBlocked, Apply: DependencyBlocked, Verify: DependencyBlocked, Archive: DependencyBlocked},
		},
		{
			...
			wantDeps:  Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyAllDone, Tasks: DependencyAllDone, Apply: DependencyReady, Verify: DependencyBlocked, Archive: DependencyBlocked},
		...
		},
		{
			...
			wantDeps:  Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyAllDone, Tasks: DependencyAllDone, Apply: DependencyAllDone, Verify: DependencyReady, Archive: DependencyBlocked},
		...
		},
		{
			...
			wantNext:   "remediate",
			wantApply:  ApplyAllDone,
			wantDeps:   Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyAllDone, Tasks: DependencyAllDone, Apply: DependencyAllDone, Verify: DependencyBlocked, Archive: DependencyBlocked},
		...
		},
		{
			...
			wantNext:  "archive",
			wantApply: ApplyAllDone,
			wantDeps:  Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyAllDone, Tasks: DependencyAllDone, Apply: DependencyAllDone, Verify: DependencyAllDone, Archive: DependencyReady},
			wantTasks: TaskProgress{Total: 1, Completed: 1, AllComplete: true},
		},
		{
			...
			wantApply:  ApplyBlocked,
			wantDeps:   Dependencies{Proposal: DependencyAllDone, Specs: DependencyAllDone, Design: DependencyAllDone, Tasks: DependencyAllDone, Apply: DependencyBlocked, Verify: DependencyBlocked, Archive: DependencyBlocked},
