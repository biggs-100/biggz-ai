...
// cross-platform half of this guard (gentle original name, kept for parity).
func TestVerifyReportPathUnderAnchorsDecidesSpellingsFromAnyPlatform(t *testing.T) {
	TestVerifyReportAnchorDecidesSpellingsFromAnyPlatform(t)
}

// TestVerifyReportAnchorDecidesSpellingsFromAnyPlatform is the
// cross-platform half of this guard (biggz work-unit name).
//
...
func TestVerifyReportAnchorDecidesSpellingsFromAnyPlatform(t *testing.T) {
...
// TestVerifyReportAnchorMatchesFilepathRel is the biggz work-unit alias for the anti-drift check.
func TestVerifyReportAnchorMatchesFilepathRel(t *testing.T) {
	TestRelativePathUnderMatchesFilepathRelOnThisPlatform(t)
}
