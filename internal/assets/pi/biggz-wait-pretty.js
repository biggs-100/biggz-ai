...
export default function biggzPiPretty(pi) {
	...
	function formatHeadlineLines(elapsedSec, runs) {
		...
		// Use unified PREVIEW budget (120) and capPreviewLines tail window for overflow
	...
	// 2-line FleetRow guarantee: FixedRightWidth=16 (elapsed 5 + tokens 10 + separator)
	...
	try {
		...
		pi._biggzWaitPretty = pi._biggzPiPretty;
	} catch {}
