...
{For routing/shell/process integration, include the applicability matrix from `skills/sdd-design/references/threat-matrix.md`. Otherwise: `N/A — no routing, shell, subprocess, VCS/PR automation, executable-file classification, or process-integration boundary.`}
...
- [skills/sdd-design/references/threat-matrix.md](skills/sdd-design/references/threat-matrix.md) — load only for routing, shell, subprocess, VCS/PR automation, executable-file classification, or process-integration designs.
