---
name: use-modern-go
description: "Use Modern Go Guidelines CLI whenever writing, modifying, fixing, or refactoring Go code. Apply version-specific modern idioms (Go 1.25). Trigger: Go files, modernize, go modern"
license: MIT
metadata:
  author: JetBrains
  version: "v0.1.1"
...
2. If the target Go version is already known, you may pass it directly:
   ...
   ```sh
   sh "<skill-dir>/scripts/run-tool.sh" list --go-version 1.25
   ```
