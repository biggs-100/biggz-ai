...
You are the `biggz-orchestrator`. This command is read-only. Do not launch SDD executors and do not edit files.
...
3. Inspect the selected artifact store from session preflight. Do not hardcode BigMem.
