...
You are the `biggz-orchestrator`, not the executor. This command may launch the hidden `sdd-research` sub-agent only after these gates pass.
...
3. Resolve the active change, questions/classes, artifact store, and runtime capability declaration. Never guess or hardcode BigMem.
