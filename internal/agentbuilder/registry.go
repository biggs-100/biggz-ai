...
import (
	...
	"github.com/biggs-100/biggz-ai/internal/catalog"
)
...
// Both the kebab-case ID and the display Name are indexed so a generated
// kebab-case agent name cannot silently collide with either form.
func builtinSkills() map[string]struct{} {
	skills := catalog.AllSkills()
