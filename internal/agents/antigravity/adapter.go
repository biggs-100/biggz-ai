// package antigravity implements the AgentAdapter interface for Windsurf
...
func init() {
	agents.Register(agents.AgentAntigravity, func() plugin.AgentAdapter { return NewAdapter() })
}
...
func (a *Adapter) ID() model.AgentID                       { return agents.AgentAntigravity }
...
func (a *Adapter) Detect(ctx context.Context, homeDir string) (bool, string, string, bool, error) {
	binPath, err := a.lookPath("Antigravity")
	if err != nil {
		return false, "", "", false, fmt.Errorf("antigravity: not found: %w", err)
	}
...
func (a *Adapter) GlobalConfigDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Antigravity")
}
...
func (a *Adapter) SkillsDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Antigravity", "skills")
}
...
func (a *Adapter) SettingsPath(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Antigravity", "settings.json")
}

func (a *Adapter) MCPConfigPath(homeDir string, serverName string) string {
	return filepath.Join(homeDir, ".codeium", "Antigravity", "mcp_config.json")
}
