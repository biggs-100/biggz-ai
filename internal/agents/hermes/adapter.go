// package hermes implements the AgentAdapter interface for Windsurf
...
func init() {
	agents.Register(agents.AgentHermes, func() plugin.AgentAdapter { return NewAdapter() })
}
...
func (a *Adapter) ID() model.AgentID                       { return agents.AgentHermes }
...
func (a *Adapter) Detect(ctx context.Context, homeDir string) (bool, string, string, bool, error) {
	binPath, err := a.lookPath("Hermes")
	if err != nil {
		return false, "", "", false, fmt.Errorf("hermes: not found: %w", err)
	}
...
func (a *Adapter) GlobalConfigDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Hermes")
}
...
func (a *Adapter) SkillsDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Hermes", "skills")
}
...
func (a *Adapter) SettingsPath(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Hermes", "settings.json")
}

func (a *Adapter) MCPConfigPath(homeDir string, serverName string) string {
	return filepath.Join(homeDir, ".codeium", "Hermes", "mcp_config.json")
}
