// Package kiro implements the AgentAdapter for Kiro IDE.
package kiro
...
func init() {
	agents.Register(agents.AgentKiro, func() plugin.AgentAdapter { return NewAdapter() })
}
