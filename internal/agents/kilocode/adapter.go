// package kilocode implements the AgentAdapter interface for Windsurf
...
func init() {
	agents.Register(agents.AgentKiloCode, func() plugin.AgentAdapter { return NewAdapter() })
}
...
func (a *Adapter) ID() model.AgentID                       { return agents.AgentKiloCode }
func (a *Adapter) Name() string                             { return "KiloCode" }
...
func (a *Adapter) Detect(ctx context.Context, homeDir string) (bool, string, string, bool, error) {
	binPath, err := a.lookPath("KiloCode")
	if err != nil {
		return false, "", "", false, fmt.Errorf("kilocode: not found: %w", err)
	}
...
func (a *Adapter) GlobalConfigDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "KiloCode")
}
...
func (a *Adapter) SkillsDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "KiloCode", "skills")
}
...
func (a *Adapter) SettingsPath(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "KiloCode", "settings.json")
}

func (a *Adapter) MCPConfigPath(homeDir string, serverName string) string {
	return filepath.Join(homeDir, ".codeium", "KiloCode", "mcp_config.json")
}
