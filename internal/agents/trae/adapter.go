// package trae implements the AgentAdapter interface for Windsurf
...
func init() {
	agents.Register(agents.AgentTrae, func() plugin.AgentAdapter { return NewAdapter() })
}
...
func (a *Adapter) ID() model.AgentID                       { return agents.AgentTrae }
func (a *Adapter) Name() string                             { return "Trae IDE" }
...
func (a *Adapter) Detect(ctx context.Context, homeDir string) (bool, string, string, bool, error) {
	binPath, err := a.lookPath("Trae IDE")
	if err != nil {
		return false, "", "", false, fmt.Errorf("trae: not found: %w", err)
	}
...
func (a *Adapter) GlobalConfigDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Trae IDE")
}
...
func (a *Adapter) SkillsDir(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Trae IDE", "skills")
}
...
func (a *Adapter) SettingsPath(homeDir string) string {
	return filepath.Join(homeDir, ".codeium", "Trae IDE", "settings.json")
}

func (a *Adapter) MCPConfigPath(homeDir string, serverName string) string {
	return filepath.Join(homeDir, ".codeium", "Trae IDE", "mcp_config.json")
}
