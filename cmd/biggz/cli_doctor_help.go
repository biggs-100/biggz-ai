...
func printHelp() {
	...
	fmt.Fprintln(os.Stderr, "  sdd-workload               Evaluate workload guard before apply")
	fmt.Fprintln(os.Stderr, "  sdd-route                  Evaluate pre-SDD routing triggers")
	...
	fmt.Fprintln(os.Stderr, "  update [--version <tag>] Check for available updates")
	fmt.Fprintln(os.Stderr, "  upgrade [--dry-run] [--version <tag>] [--no-reconcile] Upgrade biggz-ai")
