# Skill Registry — biggz-ai

<!-- Auto-generated by biggz-ai skill-registry refresh. Run `biggz skill-registry refresh` to regenerate. -->
...
| `rdd-defect-workflow` | Trigger: RDD, receipt-driven development, review authority, receipt/lineage, correction/recovery, delivery gate/kill switch, bounded review defects. Guide work. | user | `..\..\.config\opencode\skills\rdd-defect-workflow\SKILL.md` |
